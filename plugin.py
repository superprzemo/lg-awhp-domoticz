...
#
"""
<plugin key="LG_ThinQ" name="LG ThinQ" author="majki" version="2.1.2"  mod superprzemo externallink="https://github.com/majki09/domoticz_lg_thinq_plugin">
    <description>  
...
#            if (Unit == 10): # tryb silent - not working (only show current state)
#                newImage = 15
#                if (Level == 10):
